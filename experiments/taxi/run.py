...
from sverl.envs.taxi import FactoredTaxi
...
@dataclass
class AgentArgs:
    epsilon: float = 1 # Irrelevant because using value iteration.
...
# States to explain
e_obs = np.array([[0, 3, 3, 1], [0, 3, 4, 3]])
